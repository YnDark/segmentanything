...
def main(dir_path):
    ...
    predict_image("res-1.png", dir_path, device, data_transform, class_indict, model, json_path, weights_path)
    # with ThreadPoolExecutor() as executor:
    #     # for file in files:
    #     executor.submit(predict_image, "res-1.png", dir_path, device, data_transform, class_indict, model, json_path, weights_path)
