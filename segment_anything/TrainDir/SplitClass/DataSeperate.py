...
if __name__ == '__main__':
    file_path = r"D:\EdgeDownLoad\ultralytics-8.2.0\ultralytics-8.2.0\useDatasets\dataset\imgs"  # 图片文件夹
    label_path = r"D:\EdgeDownLoad\ultralytics-8.2.0\ultralytics-8.2.0\useDatasets\dataset\txt"  # 标签文件夹
    new_file_path = r"D:\EdgeDownLoad\ultralytics-8.2.0\ultralytics-8.2.0\useDatasets\seperatedlable"  # 新数据存放位置
